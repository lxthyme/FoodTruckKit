...
public struct FlavorProfile: Hashable, Codable {
    ...
    public subscript(flavor: Flavor) -> Int {
        ...
        set(newValue) {
            switch flavor {
            case .salty: return salty = newValue
            case .sweet: return sweet = newValue
            case .bitter: return bitter = newValue
            case .sour: return sour = newValue
            case .savory: return savory = newValue
            case .spicy: return spicy = newValue
            }
        }
    }
